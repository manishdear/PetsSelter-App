...
public final class PetsContract {
    ...
    public static final class PetsEntry implements BaseColumns {
        ...
        /**
         * The MIME type of the {@link # PetsContract.PetsEntry.CONTENT_URI} for a list of pets.
         */
        public static final String CONTENT_LIST_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + PetsContract.CONTENT_AUTHORITY + "/" + PetsContract.PATH_PETS;

        /**
         * The MIME type of the {@link # PetsContract.PetsEntry.CONTENT_URI} for a single pet.
         */
